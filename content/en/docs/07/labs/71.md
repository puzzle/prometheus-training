...
* Ensure that the Prometheus operator observes ServiceMonitors, PrometheusRules, PodMonitors and Probes in all namespaces
* Set the following parameters in your Prometheus custom resource
    ...
    - name: 'mailcatcher'
      emailConfigs:
        - to: 'alert@localhost'
          ...
          requireTLS: false
EOF
kubectl -n monitoring create -f mailcatcher.yml
