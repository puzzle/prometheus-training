...
Get a feel for how to use the Thanos web UI. Open the [web UI](http://{{% param replacePlaceholder.thanos %}}) and navigate to the **Graph** menu (right on top in the grey navigation bar next to Alerts).
{{% /onlyWhen %}}

Open the [web UI](http://{{% param replacePlaceholder.thanos %}}) and navigate to the **Graph** menu (right on top in the grey navigation bar next to Alerts).
